(function () {
  ...
  var I18N = {
    en: {
      ...
      "foot.rights": "Certemis — Operational Memory Layer for Companies · San Francisco, USA",

      "home.kicker": "Operational memory layer",
      "home.h1": "Ask anything. Your company <span class=\"accent\">already knows</span> the answer.",
      "home.lead": "Certemis plugs into the tools your team already works in — code, chat, tickets, wikis, docs and email — and turns them into one shared memory that answers with sources. Each person sees only what they're allowed to. No wiki to write, nothing to maintain.",
      ...
      "ld.lead": "One memory across all your tools — every answer comes with sources, and everyone sees only what they're allowed to.",
      ...
      "cmp.n2": "One current answer — matched to what you're allowed to see.",
      ...
      "prod.p": "Certemis pulls the operational knowledge scattered across your tools and your people into one place your whole team can ask in plain language — and it only ever shows each person what they're allowed to see.",
      ...
      "prod.sec.p": "Encryption in transit (TLS), AES-256-GCM encryption of credentials and integration tokens, encrypted offsite backups, strict separation between customers, EU data residency, a Data Processing Agreement with every customer, and a clear contractual commitment that your data is never used to train models.",
      ...
      "about.v2p": "Your knowledge is your most sensitive asset, so we treat it that way from day one — kept in the EU, shown only to the right people, and never used to train models.",
      ...
      "about.company": "Certemis is being incorporated as a Delaware C-corporation, based in San Francisco, USA. Customer data is hosted and stored in the EU.",

      "price.kicker": "Pricing",
      "price.h1": "Pricing that scales with your team, not against it.",
      "price.p": "Every plan includes EU data residency, a DPA, and access control by role — and we never train models on your data.",
      "price.per": "/mo",
      "price.custom": "Custom",
      ...
      "price.s.f4": "Basic access control",
      ...
      "price.g.f4": "Role-based access control",
      ...
      "price.sc.f4": "Role-based access + teams",
      ...
      "uc.d.p2": "Certemis gives one current answer to 'how do we do this here' — matched to each person's access, assembled from where your knowledge actually lives, and kept current as the work evolves.",
      ...
      "sec.f1t": "Encryption where it matters",
      "sec.f1p": "All traffic is encrypted in transit with TLS. Credentials and integration tokens are encrypted at rest with AES-256-GCM, and backups are encrypted and stored offsite within the EU.",
      ...
      "sec.f4t": "Only the right people see it",
      "sec.f4p": "Access is controlled by role, everyone starts with the minimum they need, and each workspace is strictly separated — so every answer is visible only to the right people.",
      ...
      "q5": "How is our data protected?", "a5": "EU data residency, GDPR-ready, a DPA with every customer, encryption in transit with TLS plus encrypted credentials and encrypted backups, strict separation between customers, and no training of models on your data.",
      ...
      "priv.s0.h": "Who we are",
      "priv.s0.p": "Certemis is being incorporated as a Delaware C-corporation, based in San Francisco, USA. Customer data is hosted and stored in the EU (Hetzner, Helsinki). This notice will be updated with full legal entity details once incorporation is complete.",
    ...
    pl: {
      ...
      "foot.rights": "Certemis — Warstwa Pamięci Operacyjnej dla Firm · San Francisco, USA",
      ...
      "cmp.n2": "Jedna aktualna odpowiedź — dopasowana do tego, co możesz widzieć.",
      ...
      "prod.p": "Certemis zbiera wiedzę operacyjną rozproszoną po Twoich narzędziach i ludziach w jedno miejsce, które cały zespół pyta naturalnym językiem — i zawsze pokazuje każdemu tylko to, do czego ma prawo.",
      ...
      "prod.sec.p": "Szyfrowanie w tranzycie (TLS), szyfrowanie poświadczeń i tokenów integracji algorytmem AES-256-GCM, szyfrowane kopie zapasowe offsite, ścisłe oddzielenie danych klientów od siebie, rezydencja danych w UE, umowa powierzenia (DPA) z każdym klientem oraz jasne zobowiązanie umowne, że Twoje dane nigdy nie służą do trenowania modeli.",
      ...
      "about.v2p": "Twoja wiedza to Twój najwrażliwszy zasób, więc tak ją traktujemy od pierwszego dnia — dane zostają w UE, widzą je tylko właściwe osoby i nigdy nie służą do trenowania modeli.",
      ...
      "about.company": "Certemis jest w trakcie rejestracji jako spółka typu C-corporation w stanie Delaware, z siedzibą w San Francisco (USA). Dane klientów są hostowane i przechowywane w UE.",

      "price.kicker": "Cennik",
      "price.h1": "Cennik, który rośnie z Twoim zespołem, a nie przeciw niemu.",
      "price.p": "Każdy plan zawiera przechowywanie danych w UE, umowę powierzenia (DPA) i kontrolę dostępu wg ról — i nigdy nie trenujemy modeli na Twoich danych.",
      "price.per": "/mies",
      ...
      "price.s.f4": "Podstawowa kontrola dostępu",
      ...
      "price.g.f4": "Kontrola dostępu wg ról",
      ...
      "price.sc.f4": "Kontrola dostępu wg ról + zespoły",
      "price.sc.f5": "SSO / SAML",
      ...
      "uc.d.p2": "Certemis daje jedną aktualną odpowiedź na „jak my to robimy” — dopasowaną do dostępu pytającego, złożoną z miejsc, gdzie naprawdę żyje Twoja wiedza, i aktualizowaną wraz z pracą.",
      ...
      "sec.f1t": "Szyfrowanie tam, gdzie się liczy",
      "sec.f1p": "Cały ruch jest szyfrowany w tranzycie (TLS). Poświadczenia i tokeny integracji są szyfrowane w spoczynku algorytmem AES-256-GCM, a kopie zapasowe są szyfrowane i przechowywane offsite w UE.",
      ...
      "sec.f4t": "Dostęp tylko dla właściwych osób",
      "sec.f4p": "Dostęp kontrolują role, każdy zaczyna z minimalnymi uprawnieniami, a workspace'y są od siebie ściśle oddzielone — więc każda odpowiedź trafia tylko do właściwych osób.",
      ...
      "q5": "Jak chronione są nasze dane?", "a5": "Rezydencja danych w UE, zgodność z RODO, DPA z każdym klientem, szyfrowanie w tranzycie (TLS) oraz szyfrowane poświadczenia i kopie zapasowe, ścisłe oddzielenie danych klientów od siebie i brak treningu modeli na Twoich danych.",
      ...
      "priv.s0.h": "Kim jesteśmy",
      "priv.s0.p": "Certemis jest w trakcie rejestracji jako spółka typu C-corporation w stanie Delaware, z siedzibą w San Francisco (USA). Dane klientów są hostowane i przechowywane w UE (Hetzner, Helsinki). Po zakończeniu rejestracji uzupełnimy tę informację o pełne dane spółki.",
