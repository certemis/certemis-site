(function () {
  ...
  var I18N = {
    en: {
      ...
      "prod.sec.p": "Encryption in transit and at rest, strict separation between customers, EU data residency, a Data Processing Agreement with every customer, and a clear contractual commitment that your data is never used to train models.",
      ...
      "q5": "How is our data protected?", "a5": "EU data residency, GDPR-ready, a DPA with every customer, encryption in transit and at rest, strict separation between customers, and no training of models on your data.",
    ...
    pl: {
      ...
      "prod.sec.p": "Szyfrowanie w tranzycie i w spoczynku, ścisłe oddzielenie danych klientów od siebie, rezydencja danych w UE, umowa powierzenia (DPA) z każdym klientem oraz jasne zobowiązanie umowne, że Twoje dane nigdy nie służą do trenowania modeli.",
