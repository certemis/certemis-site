(function () {
  ...
  var I18N = {
    en: {
      ...
      "home.lead": "Certemis is the operational memory layer for companies — the brain of your company. It captures the decisions, context, emails, documents and know-how that normally live only in people's heads, and gives them back to your team the moment they need them.",
      ...
      "cap.4t": "Connects to your sources", "cap.4p": "Google Drive, Gmail and any mailbox (IMAP / Proton / Outlook), GitHub, GitLab and Slack — plus upload of PDF / DOCX and scans with OCR.",
    ...
    pl: {
      ...
      "home.lead": "Certemis to warstwa pamięci operacyjnej dla firm — mózg Twojej firmy. Utrwala decyzje, kontekst, maile, dokumenty i know-how, które zwykle żyją tylko w głowach ludzi, i oddaje je zespołowi dokładnie wtedy, gdy są potrzebne.",
      ...
      "cap.4t": "Łączy się z Twoimi źródłami", "cap.4p": "Google Drive, Gmail i dowolna skrzynka (IMAP / Proton / Outlook), GitHub, GitLab i Slack — plus upload PDF / DOCX i skanów z OCR.",
